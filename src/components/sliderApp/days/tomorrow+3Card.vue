...
export default {
  ...
  computed: {
    getDateObj() {
      return this.daysDATA[this.todayIndex + this.daysNumbers.Пн.count + 3];
    },
    getFullDate() {
      return (
    ...
    getDay() {
      return this.daysDATA[this.todayIndex + this.daysNumbers.Пн.count + 3].day;
    },
  },
  methods: {
    deleteText(index) {
